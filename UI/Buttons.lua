...
function PS:CreateButtons()
	...
	auto:SetAttribute("useOnKeyDown", true)
	...
	aura:SetAttribute("useOnKeyDown", true)
	...
	seal:SetAttribute("useOnKeyDown", true)
	...
	rf:SetAttribute("useOnKeyDown", true)
	...
	for c = 1, ns.MAX_CLASSES do
		...
		cb:SetAttribute("useOnKeyDown", true)
